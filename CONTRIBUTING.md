# Contributing to terraform-module-aws-apigateway-swagger-ui
...
In short, when you submit code changes, your submissions are understood to be under the same [MIT](https://github.com/timo-reymann/terraform-module-aws-apigateway-swagger-ui/blob/main/LICENSE) that covers the project. Feel free to contact the maintainers if that's a concern.
